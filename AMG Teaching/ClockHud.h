...
private:
    ...
    void draw(sf::RenderTarget& rt, sf::RenderStates states) const
    {
		...
		elem.setPosition(500.0f,500.0f);
...
private:
    ...
    Stats_t build() const
    {
        ...
        const Stat stats[count] = {
            ...
            { sf::Color::Black,  format("FPS",   "",      m_clock->getFramesPerSecond())                   },
            { sf::Color::Black,  format("min.",  "",      m_clock->getMinFramesPerSecond())                },
            { sf::Color::Black,  format("avg.",  "",      m_clock->getAverageFramesPerSecond())            },
            { sf::Color::Black,  format("max.",  "",      m_clock->getMaxFramesPerSecond())                },
